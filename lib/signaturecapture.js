(function() {
  ...
  SignatureCapture = (function() {
    ...
    function SignatureCapture(canvasID, options) {
      ...
      this.onCanvasTouchStart = __bind(this.onCanvasTouchStart, this);      Ti.API.log('SignatureCapture init');
      this.canvas = document.getElementById(canvasID);
      Ti.API.log("canvas width: " + this.canvas.width + ", height: " + this.canvas.height);
